...
# =============================================================================
def implikacija(a, b):
    if a == b or a == False and b == negacija(a):
        return True
    else:
        return False
# =====================================================================@000916=
...
def disjunkcija_nand(a, b):
    return nand(negacija_nand(a), negacija_nand(b))
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTQsInVzZXIiOjExNDQ2fQ:1vud8t:uw_E3rgxPBMzAgmsj9yDnv5ghmHKz0tUEGouodt0kc0"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjAsInVzZXIiOjExNDQ2fQ:1vud8t:merCSY7os1e0-2sD8Jtkpi8fGOWdcfyD5wbu87Q7gSk"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTUsInVzZXIiOjExNDQ2fQ:1vud8t:8tASsD3n4OkKNDxMreov_hk_Gd693ZKS-_48VDEFCpQ"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTYsInVzZXIiOjExNDQ2fQ:1vud8t:ECcy-q8342EzJQ9-9uXSsfE7A_I1M3rnTiuy6rWyf38"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTcsInVzZXIiOjExNDQ2fQ:1vud8t:avBgLA8p41B3cvjIhNcOrf98WFvMfC06UZsjNcTf6pI"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTgsInVzZXIiOjExNDQ2fQ:1vud8t:VNFebcndVfLmoXJPtIbJAbHr8v-B-k6baW1b8-RjBNQ"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTksInVzZXIiOjExNDQ2fQ:1vud8t:whrMDIyb4o3YuQne6WuKhRG3IGTW4nPw8dWmd93EkPA"
        try:
    ...
    try:
        ...
        token = "Token 6e06040a3d0da3540cc5886f4b8dee9570e620cd"
