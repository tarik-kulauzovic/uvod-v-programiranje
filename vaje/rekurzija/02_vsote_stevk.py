...
# =============================================================================
def vsota_stevk(n):
    return 0 if n == 0 else (n % 10) + vsota_stevk(n // 10)
# =====================================================================@000957=
# 2. podnaloga
...
def vsota_vecjih_stevk(n, k=None):
    ...
    if zadnja >= k:
        return zadnja + vsota_vecjih_stevk(preostanek, k)
    else:
        return vsota_vecjih_stevk(preostanek, k)
# =====================================================================@000958=
# 3. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTYsInVzZXIiOjExNDQ2fQ:1vx9OP:ZfEUPAN_oDkzNCbDNOXU5oIZ7D71GS91wWPiN7HPQHU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTcsInVzZXIiOjExNDQ2fQ:1vx9OP:z0yNI8zuYpCKchF4_s8pTXPq1W9Q5gxhRmelrAs-rGE"
        try:
            try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTgsInVzZXIiOjExNDQ2fQ:1vx9OP:wtKDgJR6RMHIzEKh-eGXnRP8lZGwKKuxYDxT98SI6QE"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTksInVzZXIiOjExNDQ2fQ:1vx9OP:b9J2OeSuWd1z7n2bczUPhJ3CEHLMDwXh5R5iFC5kUN4"
        try:
            for i in range(1, 100):
