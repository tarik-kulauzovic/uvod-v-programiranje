...
def ali_ima_enkratne_stevke(n):
    ...
    return len(set(stevilo)) == len(stevilo)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNSwidXNlciI6MTE0NDZ9:1vx9OW:HYxy7R-PZjbtT8JJ_RW_mgj4arhr7hlxhFMoe3Yy0hk"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNiwidXNlciI6MTE0NDZ9:1vx9OW:_dwzUEFDRSlhRc4I4K3f3UGMXVsvFqJv6ZviK0t0rjg"
        try:
