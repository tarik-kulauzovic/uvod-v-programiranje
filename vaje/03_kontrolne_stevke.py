...
def vsota_kvadratov_stevk(n):
    ...
    desetice = (n // 10) % 10
    enice = n % 10
    return stotice**2 + desetice**2 + enice**2
# =====================================================================@000925=
# 2. podnaloga
...
def dodaj_kontrolno_stevko(sklic):
    ...
    for stevka in reversed(str(sklic)):
        vsota += int(stevka) * faktor
        faktor += 1
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjQsInVzZXIiOjExNDQ2fQ:1vubBR:ET8jbY8TPCEwPLUbUmS9kXzv7MB1wD3rD-LuLH8dTKA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjUsInVzZXIiOjExNDQ2fQ:1vubBR:By52r_heM9yPGmRi3WhpBifjiesQRUjth6JuqKMC7yg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjYsInVzZXIiOjExNDQ2fQ:1vubBR:7AkltLdl8OuWJOyQGvEJuyeiP8Y3G9rCepZB2B3wy5c"
        try:
