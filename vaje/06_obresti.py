...
def enostavno_obrestovanje(polog, mesecna_obrestna_mera, st_mesecev):
    vsota = polog*(1 + mesecna_obrestna_mera*st_mesecev)
    return vsota
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjIsInVzZXIiOjExNDQ2fQ:1vudgF:x4RjO0-cWD53mGKwuJcjgbfWgxZSePlJEVjrbNKgmlg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjMsInVzZXIiOjExNDQ2fQ:1vudgF:JjJPAiIceyp3TQEn2OLDSz7dkgWX1WSR8UjrHrwo0gI"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MzUsInVzZXIiOjExNDQ2fQ:1vudgF:Bxw5CDWYoKMPEfVHSQJ7_0lbHchkGkJuxMbomOfu6BY"
        try:
